...
m1 = Message.create(content: "message1", group_id: g1.id, user_id: u1.id, liked_by: nil)
m2 = Message.create(content: "message2", group_id: g1.id, user_id: u1.id, liked_by: nil)
m3 = Message.create(content: "message3", group_id: g1.id, user_id: u1.id, liked_by: nil)
m4 = Message.create(content: "message4", group_id: g1.id, user_id: u1.id, liked_by: nil)
m5 = Message.create(content: "message5", group_id: g1.id, user_id: u1.id, liked_by: nil)
m6 = Message.create(content: "message6", group_id: g1.id, user_id: u1.id, liked_by: nil)
